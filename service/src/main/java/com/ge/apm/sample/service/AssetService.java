...
public class AssetService {
    ...
    public ResponseEntity<String> timeseries(HttpServletRequest request) {
        ...
        String url = "https://apm-timeseries-services-hackapm.run.aws-usw02-pr.ice.predix.io/v2/time_series?operation=raw&tagList=POKE5-CASINO-COSMOPOLITAN-PM_UNIT.POKE5-CASINO-COSMOPOLITAN-PM_UNIT-LONGITUDE&startTime=2015-12-31T00:28:03.000Z";
